...
import jp.careapp.core.utils.EdtState.EDT_EMPTY
import jp.careapp.core.utils.EdtState.EDT_LENGTH_INVALID
import jp.careapp.core.utils.EdtState.EDT_NOT_HALFWIDTH_OR_DIGIT
import jp.careapp.core.utils.EdtState.SUCCESS
...
object StringUtils {
    ...
    const val REGEX_EMAIL =
        "^[a-z0-9][a-z0-9_\\-\\.+]{2,32}[a-z0-9\\-_]@[a-z0-9]{1,}(\\.[a-z0-9]{2,}){1,2}\$"
...
//        }
    ...
    val Int.formatCommaNumber: String
        get() = try {
            NumberFormat.getInstance(Locale.JAPAN).format(this)
        } catch (e: Exception) {
            ""
        }
}
