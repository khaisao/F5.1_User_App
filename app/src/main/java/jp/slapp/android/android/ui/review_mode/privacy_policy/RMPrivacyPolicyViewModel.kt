    ...
    private fun getDataPrivacyPolicy() {
        ...
        data.add(
            RMPrivacyPolicyModelRecyclerView(
                "プライバシーポリシーについて",
                "スパクラ(以下「本アプリ」といいます)では、登録会員(以下「ユーザー」といいます。)の皆様に安心してご利用いただくため、プライバシー及び個人情報(以下、個人情報)に関して細心の注意を払い厳重に管理いたします。本アプリのプライバシーポリシーについては以下の通りです。"
            )
        )
        data.add(
            RMPrivacyPolicyModelRecyclerView(
        ...
        data.add(
            RMPrivacyPolicyModelRecyclerView(
                "6.個人情報の削除について",
                "お客様が退会を希望する場合は、アプリ内の退会フォームから申請を行うか、supakura55@gmailにメールで申請をすることでアカウントの退会が可能です。\n" +
